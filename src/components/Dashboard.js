    ...
    <div className="p-6 flex flex-col gap-6 text-[#1E293B]">
      ...
      <div className="flex gap-5">
        {[
          ...
          <div key={i} className="bg-white w-1/3 shadow-md rounded-xl p-5">
      ...
      <div className="flex gap-6">
        ...
        <div className="w-1/2 bg-white shadow-md rounded-xl p-5">
          <div className="flex justify-between items-center mb-4">
            ...
            <a href="#" className="text-sm bg-[#F8F8FF] p-2 rounded-sm text-[#25388C]">View all</a>
          </div>
          ...
          <div className="flex flex-col gap-4">
            {loading ? (
              ...
              borrowRequests.map((req, idx) => (
                <div key={idx} className="flex items-start gap-3 bg-[#F8F8FF] p-3 rounded-lg">
        ...
        <div className="w-1/2 bg-white shadow-md rounded-xl p-5">
          ...
          <div className="flex items-center gap-3 mb-4 bg-[#F8F8FF] p-2 rounded-lg">
