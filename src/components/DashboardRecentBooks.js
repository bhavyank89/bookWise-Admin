        ...
        const fetchData = async () => {
            ...
            try {
                const [booksRes] = await Promise.all([
                    fetch("http://localhost:4000/book/fetchall")
                ]);
        ...
        <>
            <div className="w-1/2 bg-white shadow-md rounded-xl p-5">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <a href="#" className="text-sm bg-[#F8F8FF] p-2 rounded-sm text-[#25388C] hover:underline">
                        View all
                    </a>
                </div>
                ...
                <div className="flex items-center gap-3 mb-4 bg-[#F8F8FF] p-2 rounded-lg hover:bg-[#E2E8F0] transition-colors">
                    <button className="flex items-center gap-1 text-sm text-black px-3 py-1">
                        <div className="p-2 rounded-4xl bg-white mr-2">
                            <Plus size={16} />
                        </div>
                        Add New Book
                    </button>
                ...
                <div className="flex flex-col gap-4 overflow-y-auto overflow-x-auto max-h-[340px]">
                    {loading ? (
                        [...Array(3)].map((_, i) => (
